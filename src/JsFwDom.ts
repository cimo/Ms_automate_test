import { IvirtualNodeProps, IvirtualNode } from "./JsFwInterface";
...
export const createVirtualNodeFromHTML = (templateOld: string): IvirtualNode => {
    ...
    if (!firstElementChild) {
        throw new Error("@cimo/jsmvcfw => JsMvcFwDom.ts => The HTML tempalte doesn't contain a valid element!");
    }

    return createVirtualNodeFromElement(firstElementChild);
};
